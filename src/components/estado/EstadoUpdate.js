...
import { getEstadoPorId, editEstados } from '../../services/estadoEquipoService';
...
export const EstadoUpdate = () => {
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            ...
            Swal.showLoading();
            const { data } = await editEstados(estadoId, estados);
            console.log(data);
            Swal.close();
        } catch (error) {
            console.log(error);
        ...
        <div className='container-fluid mt-3 mb-2'>
            <div className="card">
                <div className="card-header">
                    <h5 className="card-title">Editar Estado</h5>
                </div>
